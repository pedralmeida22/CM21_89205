...
import pt.ua.myfirstapp.databinding.FragmentFirstBinding
...
class FirstFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.random_button).setOnClickListener {
            val countText = view.findViewById<TextView>(R.id.textview_first)
            var value = countText.text.toString().toInt()
